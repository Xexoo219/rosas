...
class Estudiante extends Model
{
    ...
    protected $fillable = ['id','cursos_id', 'ensenanzas_id' ,'nombres','apellidos','rut', 'domicilio','comuna','codigo_barra','entrada_especial', 'permisos_entrada_id', 'salida_especial','permisos_salida_id',
