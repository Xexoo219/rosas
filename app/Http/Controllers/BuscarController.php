...
class BuscarController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      // $products = Product::all();
        ...
        $estudiantes = Estudiante::name($request->get('name'))->orderBy('id','ASC')->paginate(10);
        return view('buscar.index',compact('estudiantes','curso','ensenanza', 'permiso'))
